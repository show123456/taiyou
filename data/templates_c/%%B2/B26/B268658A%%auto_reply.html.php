<?php /* Smarty version 2.6.19, created on 2015-06-12 14:21:18
         compiled from D:%5Cwamp%5Cwww%5C/home/info/templates/auto_reply.html */ ?>
<div class=" main-content">
    <div class="inner">
        <div class="alert alert-warning alert-dismissable fz12px">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            <p>
            用户发送关键字/关键词后，并无匹配结果后的返回的信息。可以写一些提醒用户的相关操作等。
            </p>
        </div>
...
"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-offset-2 col-sm-10">
						...
						<input type="hidden" name="id" value="<?php echo $this->_tpl_vars['replyRow']['id']; ?>
">
...
<script type="text/javascript">
    set_title_name('无匹配回复设置');
    set_menu_cur('menu_12','cur');
