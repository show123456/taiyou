...
foreach($listArr as $key=>$value){
	...
	$memRow=$memberModel->where("fromuser='".$value['fromuser']."'")->dataRow();
	$listArr[$key]['nickname']=$memRow['nickname'];
	$listArr[$key]['pic']=$memRow['headimgurl'];
}
$smarty->assign('list',$listArr);
$smarty->assign('page',$model->pager($data['pager']));
$smarty->setTpl('member/templates/ext_index.html')->display();