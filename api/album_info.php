...
class album_info{
	...
	public function getAlbum(){
		$applistalbumModel = new Model_ApplistAlbum();
		$filter['where'] = " customer_id='$this->customer_id' and state='1' ";
		$sql=$applistalbumModel->select($filter);
		$inforesult = $applistalbumModel->fetchRow($sql);
		$data['msgtype']	= 'news';
		...
		$data['url'] = 'http://'.$_SERVER['HTTP_HOST'] . "/mobile/album/index.php?fromuser=".$this->fromuser."&sign=".$this->timesign;
