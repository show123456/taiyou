...
function aler(tit,thi,tim){
	tim = tim || 2;
	layer.tips(tit, thi, {
		style: ['background-color:#F5620D; color:#fff', '#F5620D'],
		maxWidth:150,
		time:tim
	});
}
